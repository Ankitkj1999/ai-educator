...
const PricingPlan = (props) => {
    ...
    return (
        <Card className="max-w-sm w-full h-full shadow-none border border-black rounded-none mt-3 px-8 py-5 dark:bg-black dark:border-white flex flex-col justify-between">
            <div>
                ...
                <ul className="my-7 space-y-5">
                    <li className="flex space-x-3">
                        <svg className="h-5 w-5 shrink-0 text-black dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <li className="flex space-x-3">
                        ...
                        <span className="text-base max-md:text-xs font-normal leading-tight text-black dark:text-white">{props.data.four}</span>
                    </li>
                    <li className="flex space-x-3">
                        <svg className="h-5 w-5 shrink-0 text-black dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-base max-md:text-xs font-normal leading-tight text-black dark:text-white">{props.data.five}</span>
                    </li>
                    <li className="flex space-x-3">
                        <svg className="h-5 w-5 shrink-0 text-black dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-base max-md:text-xs font-normal leading-tight text-black dark:text-white">{props.data.seven}</span>
                    </li>
                    <li className="flex space-x-3">
                        <svg className="h-5 w-5 shrink-0 text-black dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <button
                ...
                className="inline-flex w-full justify-center dark:bg-white dark:text-black bg-black px-5 py-2.5 text-center text-sm font-bold text-white whitespace-nowrap"
            >
